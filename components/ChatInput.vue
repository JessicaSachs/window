  ...
  <form @submit.prevent="$emit('submit')">
    <div class="flex items-center w-full p-4">
      <input v-model="message" type="text" :placeholder="placeholder"
        class="w-full p-1 text-sm text-black focus:outline-indigo-500 outline-transparent outline-offset-2 border-2 border-indigo-200 bg-transparent bg-gray-100 rounded-md grow placeholder:text-slate-500 font-light selection:bg-indigo-200" />
